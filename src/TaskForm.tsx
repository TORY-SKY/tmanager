...
const TaskForm: React.FC<TaskFormProperty> =({addTask})=>{
	...
	<div className="w-full lg:w-md mx-auto  lg:px-40 ">
		<form onSubmit={handleSubmit} className="backfrop-filter backdrop-blur-md bg-opacity-50 bg-white flex flex-col  w-full gap-3 lg:px-5 dark:text-gray-200  py-4 h-full border p-3 rounded-2xl shadow-xl dark:bg-gray-800 dark:text-white dark:border-none">
