...
// })
	...
	return (
		...
		<div className="backfrop-filter backdrop-blur-md bg-opacity-50 bg-white rounded-3xl p-5 shadow-lg  border my-3 dark:bg-gray-800 dark:border-none dark:text-white" >
			...
			<div className="flex justify-end  ">
				...
				<button className="hover:bg-gray-100 px-2 hover:bg-gray-100 dark:hover:bg-gray-900 dark:rounded" title="delete" onClick={()=>onDelete(tasks)}><Trash2 className="h-4 w-4 text-black-600 hover:text-red-600 " /></button>
			</div>
